...
public class Calculator implements ActionListener   {
  ...
  JFrame jf; 
  JLabel displayLabel;
  JButton sevenButton,eightButton,nineButton,fiveButton,sixButton,fourButton;
  JButton dotButton,zeroButton, threeButton,twoButton,oneButton,plusButton,minusButton,divButton,equalButton,mulButton,clearButton;
  boolean isOperatorClicked =false;
  String oldValue,newValue;
  float plusResult,minusResult,result,oldValueF,newValueF;
  char flag;
    ...
    public Calculator  (){
     ...
     equalButton .setFont(new Font("Arial", Font.PLAIN, 40));
      ...
      clearButton.setBounds(430,430,128, 80);
